/**
 * updating state by key value pairs
 * @param updateKeyValue key value pairs for updating state objects
 * @param callback callback function after state updated
 */
...
/**
 * updating state by key, value not batch update
 * @param prop property chain
 * @param value updating value
 * @param noNeedUpdate no need update for batch update method updateStates
 * @param callback state callback function after state updated
 * @returns void
 */
